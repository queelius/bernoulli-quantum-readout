# Cover letter: submission to *Quantum Science and Technology*
...
for publication in *Quantum Science and Technology*.
...
**Fit with the journal.** *Quantum Science and Technology* covers the science and
engineering of near-term quantum technologies, including the characterization,
budgeting, and mitigation of device error that make NISQ-era and early
fault-tolerant computation usable. A reusable, symbolic, forward error-budgeting
tool for the classical post-processing of measurement outcomes, validated on real
device calibration and tied directly to syndrome extraction, sits squarely within
that remit. It is a design-time complement to the numerical mitigation methods the
community already uses, and it speaks to both the quantum-error-correction and the
measurement-characterization audiences the journal serves.
...
The work is original and not under consideration elsewhere, and every result is
reproducible (the validation figure regenerates from a self-contained script that
carries the calibration snapshot inline). It is part of a family of preprints on
Bernoulli type theory, posted on Zenodo.
