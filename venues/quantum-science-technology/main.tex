...
and keeps climbing while the exact value saturates toward $\tfrac12$. The gap
...
Three things are visible at once on hardware numbers. The closed form sits exactly
...
correlated-channel (CTMP-regime) lift of the same operations and a
\emph{live-hardware} study of predicted against measured derived-bit rates,
beyond the simulation validation of \cref{sec:worked-real}.
