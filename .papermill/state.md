...
- This paper (`bernoulli-quantum-readout`) is **minted** (direct Zenodo API via `docs/zenodo/mint.py`, GitHub-login account). **Concept DOI 10.5281/zenodo.20584894** (cite this; resolves to latest). Versions: v1 `10.5281/zenodo.20584895`; **v2 `10.5281/zenodo.20586587`** (current; adds the fan-out caveat + the m4/m5/m6 notation polish), record <https://zenodo.org/record/20586587>. Next revision: edit, rebuild, then `python3 docs/zenodo/mint.py newversion 20586587 papers/bernoulli-quantum-readout/main.pdf papers/bernoulli-quantum-readout`.
